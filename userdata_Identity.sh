...
export ConnectionStrings__identity="Host=bookstoredb-jcl.cvipzbxhdebi.eu-central-1.rds.amazonaws.com;Database=identity;Username=pencil42;Password=woppie123"
export Web__Host="server-jcl.sbx.pencil42-apps.be"
